                    ...
                    <tbody>
                        @foreach ($table as $t)
                            <tr>
                                ...
                                <td class="text-end">
                                    <button type="button" data-id="{{ $t->id }}" data-username="{{ $t->username }}"
                                        data-avatar="{{ $t->getAvatar() }}" data-email="{{ $t->email }}"
                                        data-phone="{{ $t->phone }}" data-status="{{ $t->status }}"
                                        data-role="{{ $t->user_role }}"
